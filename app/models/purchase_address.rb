class PurchaseAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, delivery_source_id: delivery_source_id, municipali: municipali,
                   city_string: city_string, bilding_name: bilding_name, phone_number: phone_number, purchase_id: purchase.id)
  end
end
